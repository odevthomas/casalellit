...
const navigation = [
  { title: "A Casa e Nossos Serviços", path: "/casalellit" },
...
const Header = () => {
  ...
  return (
    ...
    >
      ...
      <div
        className="relative w-full h-[30vh] bg-gradient-to-b from-[#00000000] opacity-390"
      >
        {/* Logo no canto superior esquerdo com borda e aumento */}
        ...
        >
          <a href="/">
            <img
              ...
              className="h-20 sm:h-24 md:h-24 lg:h-28"
              style={{
